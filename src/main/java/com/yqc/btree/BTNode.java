...
public class BTNode {
    ...
    public boolean addChild(BTNode child) {
        ...
        Collections.sort(childNodes, new Comparator<BTNode>() {
            ...
            @Override
            public int compare(BTNode o1, BTNode o2) {
//				System.out.println(o1.getKeys() == o2.getKeys() ? "相等":"不相等");
//				System.out.println("o1.getKeys().get(0) = " + o1.getKeys().get(0));
//				System.out.println("o2.getKeys().get(0) = "+ o2.getKeys().get(0));
                return o1.getKeys().get(0).compareTo(o2.getKeys().get(0));
            }
        });
